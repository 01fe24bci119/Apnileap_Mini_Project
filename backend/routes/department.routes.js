...
const { listDepartmentThemes, createTheme } = require('../controllers/theme.controller');
...
router.get('/:departmentId/themes', requireDepartmentScope('departmentId'), listDepartmentThemes);
router.post('/:departmentId/themes', requireRole(...MENTOR_UP), requireDepartmentScope('departmentId'), createTheme);
